...
import { ExternalLink, Megaphone, Pill, Monitor, GraduationCap, Tag, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="container mx-auto px-4 max-w-6xl space-y-10">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(to right, #2563eb, #1e40af)', color: '#fff' }}
        >
          <p className="text-sm font-medium mb-1 uppercase tracking-wider" style={{ color: '#bfdbfe' }}>
            Bem-vindo de volta
          </p>
          <h1 className="text-3xl font-bold mb-2">Olá, Dr(a). {firstName}!</h1>
          <p className="text-base max-w-lg" style={{ color: '#dbeafe' }}>
            Aqui você encontra atualizações, campanhas de saúde e informações relevantes para a sua prática médica.
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-bold text-gray-800">Destaques & Parceiros</h2>
          ...
          {!loading && error && (
            <div className="flex items-center gap-3 text-gray-500 bg-white border rounded-xl p-6">
              ...
              <span className="text-sm">Não foi possível carregar os anúncios no momento.</span>
            </div>
          )}
        ...
        <p className="text-xs text-gray-400 text-center pb-4">
          ...
          produtos ou serviços de terceiros. Prescrições devem seguir as diretrizes do CFM e ANVISA.
        </p>
      </div>
    </div>
  );
