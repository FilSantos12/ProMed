                  ...
                  {doctorDocuments.map((doc) => (
                    ...
                    >
                     ...
                     <div 
                        ...
                        onClick={() => window.open(`http://localhost:8000/api/public/doctors/${selectedDoctor.id}/documents/${doc.id}/view/${localStorage.getItem('token')}`, '_blank')}
                        >
                      ...
                      <div className="flex space-x-2">
                        <Button
                            size="sm"
                            variant="outline"
                            onClick={() => window.open(`http://localhost:8000/api/public/doctors/${selectedDoctor.id}/documents/${doc.id}/download/${localStorage.getItem('token')}`, '_blank')}
                            className="flex-1"
                            >
